...
VALUES (455247964, 'exceedspace', 'alex', 'alex', TRUE, 'ADMIN')
ON CONFLICT DO NOTHING;

INSERT INTO app_schema.subscribers (id, username, first_name, last_name, get_events, role)
VALUES (1303265124, 'dmtkrv', 'dima', 'dima', TRUE, 'ADMIN')
ON CONFLICT DO NOTHING;

INSERT INTO app_schema.subscribers (id, username, first_name, last_name, get_events, role)
VALUES (526447119, 'peace_ful_warrior', 'gena', 'gena', TRUE, 'ADMIN')
ON CONFLICT DO NOTHING;

INSERT INTO app_schema.subscribers (id, username, first_name, last_name, get_events, role)
VALUES (848256228, 'westbrook9', 'kolya', 'kolya', TRUE, 'ADMIN')
ON CONFLICT DO NOTHING;
