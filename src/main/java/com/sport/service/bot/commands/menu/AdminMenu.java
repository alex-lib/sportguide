...
public class AdminMenu {
    ...
    public static final String ADMIN_MENU = """
               ...
               Доступные команды:
               📍 Выбрать место - выбрать место (по дефолту ты можешь найти сейчас одно место загруженное в БД: центральный-футбольное поле-помещение)
               ...
               🔎 Получить кол-во подписавшихся юзеров - получить кол-во подписавшихся юзеров на получение событий
               \s""";
