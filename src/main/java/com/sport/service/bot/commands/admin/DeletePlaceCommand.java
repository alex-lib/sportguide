...
public class DeletePlaceCommand implements IBotCommand, TextProcessable {
    ...
    public String getCommandIdentifier() {
        return CommandsConstants.DELETE_PLACE;
    }

    @Override
    public String getDescription() {
        return CommandsConstants.DELETE_PLACE_DESCRIPTION;
    }
    ...
    public void processMessage(AbsSender absSender, Message message, String[] arguments) {
        ...
        try {
            ...
            sender.sendMessageWithoutPhoto(chatId, CommandsConstants.DELETING_PLACE_INSTRUCTION);
        } catch (Exception e) {
    ...
    public void processTextInput(AbsSender absSender, Message message) {
        ...
        try {
            ...
            commandStateStore.clearCurrentCommand(userId);
            sender.sendMessageWithoutPhoto(chatId, CommandsConstants.PLACE_DELETED);
        } catch (Exception e) {
